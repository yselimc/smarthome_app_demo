...
"border-radius: 45px;"));
        ...
        roomListWidget->setFrameShape(QFrame::StyledPanel);
...
"color:white"));
        ...
        addRoomButton->setCursor(QCursor(Qt::PointingHandCursor));
...
""));
        ...
        removeRoomButton->setCursor(QCursor(Qt::PointingHandCursor));
...
"border-image: url(:/image/images/del.png);"));
        ...
        editRoomButton->setCursor(QCursor(Qt::PointingHandCursor));
...
"border-image: url(:/image/images/edit1.png);"));
        ...
        addDeviceButton->setCursor(QCursor(Qt::PointingHandCursor));
...
"border-image: url(:/image/images/add.jpg);"));
        ...
        removeDeviceButton->setCursor(QCursor(Qt::PointingHandCursor));
...
"border-image: url(:/image/images/del.png);"));
        ...
        SelectedRoomTable->setLayoutDirection(Qt::LeftToRight);
        SelectedRoomTable->setStyleSheet(QString::fromUtf8("border-image:url(:/image/images/yaziback.jpg);"));
        SelectedRoomTable->setAlignment(Qt::AlignCenter);
